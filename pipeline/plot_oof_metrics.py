...
ARM_LABEL = {"bulkrna": "Bulk RNA-seq alone (no imputation)",
             "multimodal": "MATRIX-AML multimodal (8 modalities)"}
...
p1 = os.path.join(OUTD, "MATRIX-AML_multimodal_vs_bulkRNA_overview.pdf")
...
p2 = os.path.join(OUTD, "MATRIX-AML_multimodal_vs_bulkRNA_per_mutation.pdf")
...
# ------------------------------------------------------------------ 3. the numbers
p3 = os.path.join(OUTD, "MATRIX-AML_multimodal_vs_bulkRNA_metrics.tsv")
